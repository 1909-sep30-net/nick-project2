...
let FridgeApiService = class FridgeApiService {
    constructor(httpClient) {
        this.httpClient = httpClient;
    }
    getItems() {
        const url = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].fridgeApiBaseUrl}/api/fridgeitems`;
        return this.httpClient.get(url).toPromise();
    }
};
FridgeApiService.ctorParameters = () => [
